...
public class MysqlCricketerDAOImpl implements CricketerDAO {
	private final static String CRICKETER_INSERT_QUERY = "INSERT INTO CRICKETER(CNAME,CADD,BATAVG,BOWLAVG) VALUES(?,?,?,?)";
	private DataSource ds;

	public MysqlCricketerDAOImpl(DataSource ds) {
		this.ds = ds;
	}
